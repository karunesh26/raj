					...
					ModulesManager.run('AdminPanelWebclient', 'registerAdminPanelTab', [
						function(resolve) {
							__webpack_require__.e/* nsure */(1/*! admin-bundle */, function() {
									resolve(__webpack_require__(/*! modules/Facebook/js/views/AdminSettingsView.js */ 285));
								});
						},
			...
			return {
				start: function (ModulesManager) {
					ModulesManager.run('SettingsWebclient', 'registerSettingsTab', [
						function () { return __webpack_require__(/*! modules/Facebook/js/views/FacebookSettingsFormView.js */ 284); },
						Settings.HashModuleName,
						TextUtils.i18n('FACEBOOK/LABEL_SETTINGS_TAB')
					]);
				}
