					...
					ModulesManager.run('AdminPanelWebclient', 'registerAdminPanelTab', [
						function(resolve) {
							__webpack_require__.e/* nsure */(1/*! admin-bundle */, function() {
									resolve(__webpack_require__(/*! modules/Google/js/views/AdminSettingsView.js */ 289));
								});
						},
			...
			return {
				start: function (ModulesManager) {
					ModulesManager.run('SettingsWebclient', 'registerSettingsTab', [
						function () { return __webpack_require__(/*! modules/Google/js/views/GoogleSettingsFormView.js */ 288); },
						Settings.HashModuleName,
						TextUtils.i18n('GOOGLE/LABEL_SETTINGS_TAB')
					]);
				}
