				...
				start: function (ModulesManager) {
					if (ModulesManager.isModuleEnabled('MailWebclient'))
					{
						App.subscribeEvent('MailWebclient::RegisterMessagePaneController', function (fRegisterMessagePaneController) {
							fRegisterMessagePaneController(__webpack_require__(/*! modules/MailSensitivityWebclientPlugin/js/views/MessageControlView.js */ 301), 'BeforeMessageHeaders');
						});
						ModulesManager.run('MailWebclient', 'registerComposeToolbarController', [__webpack_require__(/*! modules/MailSensitivityWebclientPlugin/js/views/ComposeDropdownView.js */ 302)]);
					}
				}
			};
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ko = __webpack_require__(/*! knockout */ 46);
