...
Route::get('dashboard_employee/{type}/{id}', 'Dashboard@dashboard_employee')->name('dashboard_employee');

Route::post('marketing_employee_details', 'Dashboard@marketing_employee_details');
Route::post('Sales_Employee_Work_Detail', 'Dashboard@Sales_Employee_Work_Detail');
Route::post('prise_issue_notify', 'Dashboard@prise_issue_notify');
Route::post('revise_notify_data', 'Dashboard@revise_notify_data');
...
Route::post('Follow_up/search_pending_enq', 'Follow_up@search_pending_enq');
Route::post('Follow_up/search_visit_done', 'Follow_up@search_visit_done');
