...
class Followup_way_master extends Controller
{
	public $table="followup_way_master";
	public $primary_id="followup_way_id";
	public $field = "followup_way_name";
	public $msgName = "Follow-up Way";
	public $view = "followup_way_master";
	public $controller = "Followup_way_master";
	public $module_name = "followup_way_master";
	public $utility;
	public $role_id;
	public $user_id;
