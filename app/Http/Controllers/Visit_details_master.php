...
class Visit_details_master extends Controller
{
	public $table="visit_details_master";
	public $primary_id="visit_details_id";
	public $field = "visit_details_name";
	public $msgName = "Visit Details";
	public $view = "visit_details_master";
	public $controller = "Visit_details_master";
	public $module_name = "visit_details_master";
	public $utility;
	public $role_id;
	public $user_id;
