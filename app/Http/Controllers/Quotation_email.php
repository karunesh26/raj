...
class Quotation_email extends Controller
{
	public $table="quotation_email";
	public $primary_id="id";
	public $field = "email";
	public $msgName = "Quotation Email";
	public $view = "quotation_email";
	public $controller = "Quotation_email";
	public $module_name = "quotation_email";
	public $utility;
	public $role_id;
	public $user_id;
