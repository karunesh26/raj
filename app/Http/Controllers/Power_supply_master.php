...
class Power_supply_master extends Controller
{
	public $table="power_supply_master";
	public $primary_id="power_supply_id";
	public $field = "power_supply_name";
	public $msgName = "Power Supply";
	public $view = "power_supply_master";
	public $controller = "Power_supply_master";
	public $module_name = "power_supply_master";
	public $utility;
	public $role_id;
	public $user_id;
