...
class Quatation_status_master extends Controller
{
	public $table="quatation_status_master";
	public $primary_id="quatation_status_id";
	public $field = "quatation_status_name";
	public $msgName = "Quatation Status";
	public $view = "quatation_status_master";
	public $controller = "Quatation_status_master";
	public $module_name = "quatation_status_master";
	public $utility;
	public $role_id;
	public $user_id;
