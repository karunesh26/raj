...
class Country extends Controller
{
	...
	public $primary_id="country_id";
	public $foreign_table = "zone_master";
	public $foreign_id = "zone_id";
	public $field = "country_name";
	public $msgName = "Country";
	public $view = "country";
	...
	public function index()
	{
		...
		$orderField = $masterTable.'.'.$this->field;
		$orderType = 'ASC';
		$where = array();
	...
	public function insert(Request $request)
	{
		...
		$data = array($this->field=>$name,'zone_id'=>$zone_id,'cur_type'=>$cur_type);
	...
	{
		$name  = trim(ucwords($request->input('name')));
		$whereData = array($this->field=>$name,'delete_status'=>0);
