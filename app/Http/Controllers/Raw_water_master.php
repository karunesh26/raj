...
class Raw_water_master extends Controller
{
	public $table="raw_water_master";
	public $primary_id="raw_water_id";
	public $field = "raw_water_name";
	public $msgName = "Raw Water";
	public $view = "raw_water_master";
	public $controller = "Raw_water_master";
	public $module_name = "raw_water_master";
	public $utility;
	public $role_id;
	public $user_id;
