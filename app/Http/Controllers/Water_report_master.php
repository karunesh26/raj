...
class Water_report_master extends Controller
{
	public $table="water_report_master";
	public $primary_id="water_report_id";
	public $field = "water_report_name";
	public $msgName = "Water Report";
	public $view = "water_report_master";
	public $controller = "Water_report_master";
	public $module_name = "water_report_master";
	public $utility;
	public $role_id;
	public $user_id;
