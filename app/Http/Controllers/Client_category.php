...
class Client_category extends Controller
{
	public $table="client_category_master";
	public $primary_id="client_category_id";
	public $field = "client_category_name";
	public $msgName = "Client Category";
	public $view = "client_category";
	public $controller = "Client_category";
	public $module_name = "client_category";
	public $utility;
	public $role_id;
	public $user_id;
