...
class Planning_stage_master extends Controller
{
	public $table="planning_stage_master";
	public $primary_id="planning_stage_id";
	public $field = "planning_stage_name";
	public $msgName = "Planning Stage";
	public $view = "planning_stage_master";
	public $controller = "Planning_stage_master";
	public $module_name = "planning_stage_master";
	public $utility;
	public $role_id;
	public $user_id;
