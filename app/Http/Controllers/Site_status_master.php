...
class Site_status_master extends Controller
{
	public $table="site_status_master";
	public $primary_id="site_status_id";
	public $field = "site_status_name";
	public $msgName = "Site Status";
	public $view = "site_status_master";
	public $controller = "Site_status_master";
	public $module_name = "site_status_master";
	public $utility;
	public $role_id;
	public $user_id;
