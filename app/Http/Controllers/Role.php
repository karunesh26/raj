...
class Role extends Controller
{
	...
	public $field = "role_name";
	public $msgName = "Employee Designation";
	public $view = "role_master";
	...
	public function index()
	{
		...
		$data['result'] = Data_model::retrive($this->table,'*',array(array($this->primary_id, '<>', '1')),$this->field,'ASC');
