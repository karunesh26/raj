...
class Big_zone_amount extends Controller
{
	public $table="big_zone_amount";
	public $primary_id="id";
	public $field = "rate";
	public $msgName = "Big Zone Amount";
	public $view = "big_zone_amount";
	public $controller = "Big_zone_amount";
	public $module_name = "big_zone_amount";
	public $utility;
	public $role_id;
	public $user_id;
	...
	public function index()
	{
		...
		$data['result'] = Data_model::retrive($this->table,'*',array(),'rate','ASC');
