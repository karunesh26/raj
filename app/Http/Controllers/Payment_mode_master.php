...
class Payment_mode_master extends Controller
{
	public $table="payment_mode_master";
	public $primary_id="payment_mode_id";
	public $field = "payment_mode_name";
	public $msgName = "Payment Mode";
	public $view = "payment_mode_master";
	public $controller = "Payment_mode_master";
	public $module_name = "payment_mode_master";
	public $utility;
	public $role_id;
	public $user_id;
