                      ...
                      <table id="datatable" class="table table-bordered table-striped">
                       ...
                       <tbody>
                            ...
                            <tr>
                                <td>{{ $key+1}}</td>
                                <td>{{ $value->$field}}</td>
								<td><a target="_blank" class="btn btn-success" href="external/catalog/{{ $value->catalog_file }}">File View</a></td>
                                <td>
                                    @if($role_id == 1)
									    ...
									    <a class="btn bg-maroon btn-flat btn-sm" onclick="return confirm('Are You Sure To Delete This Catelog ?')" href="<?php echo $controller_name;?>/delete/<?php echo $utility->encode($value->$primary_id); ?>"><i class="glyphicon glyphicon-trash icon-white"></i></a>
                                    @else
