                      ...
                      <table id="datatable" class="table table-bordered table-striped">
                       ...
                       <tbody>
                            ...
                            <tr>
								...
								@php
									$email_title = array('inquiry'=>'Inquiry Reminder','quotation'=>'Quotation','follow_up'=>'Follow-up Reminder');
									
									foreach($email_title as $key=>$val)
									{
										if($key == $value->$field)
											echo $val;
									}
                                ...
                                <td>
                                  @if($role_id == 1)
                                    ...
                                    <a class="btn bg-maroon btn-flat btn-sm" onclick="return confirm('Are You Sure To Delete This Email Format ?')" href="<?php echo $controller_name;?>/delete/<?php echo $utility->encode($value->$primary_id); ?>"><i class="glyphicon glyphicon-trash icon-white"></i></a>
                                  @else
