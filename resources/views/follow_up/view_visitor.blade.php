				...
				<div class="box box-primary">
					...
					<div class="form-group col-sm-12">
						<div class="col-sm-4">
							...
							<input type="text" name="visitor_visit_date" id="visitor_visit_date" readonly value="{{ date('d-m-Y',strtotime($result[0]->visit_date)) }}" class="form-control input-sm" />
						</div>
						<div class="col-sm-4">
							<label class="control-label" >Visit Time<span class="required">*</span></label>
							<input type="text" readonly name=""  id="" value="{{ $result[0]->visit_time }}" class=" form-control input-sm" />
						</div>
						<div class="col-sm-4">
