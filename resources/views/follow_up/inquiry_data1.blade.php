                ...
                <div class="tab-pane " id="follow_up">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-sm-12">
                                <div class="form-group col-sm-2">
                                    {!! Form::label('Time For Next Follow') !!}
                                </div>
                                <div class="form-group col-sm-4">
                                    {!! Form::text('next_follow_time','', array('class' => 'form-control next_follow_time' ,'id'=>"next_follow_time",'readonly' => 'readonly')) !!}
                                </div>
                            </div>
                                    ...
                                    <table id="datatable" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="15%">Next Follow-Up Time</th>
                    ...
                    <div class="box box-warning">
                        <div class="box-body">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="form-group col-sm-4">
                                    <input name="document_related_detail" type="text" class="form-control" id="document_related_detail" />
                                </div>
                            </div>
                            @if($role_id == 1)
                            <div class="form-group col-sm-12">
                                    ...
                                    <table id="datatable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $value->d}}</td>
                                                <td>{{ $value->username}}</td>
                                                <td>{{ $value->document_related_detail}}</td>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input value="{{(isset($result[0]->name))? $result[0]->name : '' }}" type="text" name="visitor_client_name1" id="visitor_client_name1" class="form-control input-sm clear_data" />
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input value="{{(isset($result[0]->mobile))? $result[0]->mobile : '' }}" type="text" name="visitor_client_mobile1" maxlength="10" id="visitor_client_mobile1" class="form-control input-sm clear_data" />
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input value="{{(isset($result[0]->email))? $result[0]->email : '' }}" type="text" name="visitor_client_email1" id="visitor_client_email1" class="form-control input-sm clear_data" />
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input value="{{(isset($result[0]->mobile_2))? $result[0]->mobile_2 : '' }}" type="text" name="visitor_client_mobile2" maxlength="10" id="visitor_client_mobile2" class="form-control input-sm clear_data" />
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input value="{{(isset($result[0]->email_2))? $result[0]->email_2 : '' }}" type="text" name="visitor_client_email2" id="visitor_client_email2" class="form-control input-sm clear_data" />
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input value="{{(isset($result[0]->mobile_3))? $result[0]->mobile_3 : '' }}" type="text" name="visitor_client_mobile3" maxlength="10" id="visitor_client_mobile3" class="form-control input-sm clear_data" />
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input value="{{(isset($result[0]->company))? $result[0]->company : '' }}" type="text" name="visitor_company_name" id="visitor_company_name" class="form-control input-sm clear_data" />
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input value="{{(isset($result[0]->landline))? $result[0]->landline : '' }}" type="text" name="visitor_landline_no" id="visitor_landline_no" class="form-control input-sm clear_data" />
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <textarea name="visitor_address" id="visitor_address" class="form-control input-sm clear_data">{{(isset($result[0]->address))? $result[0]->address : '' }}</textarea>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <textarea name="visitor_office_address" id="visitor_office_address"  class="form-control input-sm clear_data">{{(isset($result[0]->office_address))? $result[0]->office_address : '' }}</textarea>
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select name="visitor_country" id="visitor_country" class="select2 clear_data_select" style="width:100%">
                                        ...
                                        <option value="{{ $v->country_id}}" {{(isset($result[0]->country_id) && $result[0]->country_id == $v->country_id)? 'selected' : '' }}> {{ $v->country_name}}</option>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select name="visitor_state" id="visitor_state" class="select2 clear_data_select" style="width:100%">
                                        ...
                                        <option value="{{ $v->state_id}}" {{(isset($result[0]->state_id) && $result[0]->state_id == $v->state_id)? 'selected' : '' }}> {{ $v->state_name}}</option>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select name="visitor_city" id="visitor_city" class="select2 clear_data_select" style="width:100%">
                                        ...
                                        <option value="{{ $v->city_id}}" {{(isset($result[0]->city_id) && $result[0]->city_id == $v->city_id)? 'selected' : '' }}> {{ $v->city_name}}</option>
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input value="{{(isset($visiting_detail[0]->land))? $visiting_detail[0]->land : '' }}" type="text" name="visitor_land" id="visitor_land" class="form-control input-sm clear_data" />
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select name="visitor_site_status" id="visitor_site_status" class="select2 clear_data_select" style="width:100%">
                                        ...
                                        <option value="{{ $v->site_status_id}}" {{(isset($result[0]->site_status_id) && $result[0]->site_status_id == $v->site_status_id)? 'selected' : '' }}> {{ $v->site_status_name }}</option>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select name="visitor_power_supply" id="visitor_power_supply" class="select2 clear_data_select" style="width:100%">
                                        ...
                                        <option value="{{ $v->power_supply_id}}" {{(isset($result[0]->power_supply_id) && $result[0]->power_supply_id == $v->power_supply_id)? 'selected' : '' }}> {{ $v->power_supply_name }}</option>
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select name="visitor_water_source" id="visitor_water_source" class="select2 clear_data_select" style="width:100%">
                                        ...
                                        <option value="{{ $v->raw_water_id }}" {{(isset($result[0]->raw_water_id) && $result[0]->raw_water_id == $v->raw_water_id)? 'selected' : '' }}> {{ $v->raw_water_name }}</option>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select name="visitor_water_report" id="visitor_water_report" class="select2 clear_data_select" style="width:100%">
                                        ...
                                        <option value="{{ $v->water_report_id }}" {{(isset($result[0]->water_report_id) && $result[0]->water_report_id == $v->water_report_id)? 'selected' : '' }}> {{ $v->water_report_name }}</option>
...
<input type="text" name="attended_by" class="form-control" placeholder="Attended by name..!" />
                        </div>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function ($) {
        ...
        $(".next_follow_date").datepicker({
            autoclose: true,
            startDate: '+1d',
            format: "dd-mm-yyyy"
        });
        $(".next_follow_time").timepicker({
            autoclose: true,
        });
