                            ...
                            <tr>
                                ...
                                <td>
                                  @if($role_id == 1)
                                    ...
                                    <a class="btn bg-maroon btn-flat btn-sm" onclick="return confirm('Are You Sure To Delete This Address ?')" href="<?php echo $controller_name;?>/delete/<?php echo $utility->encode($value->$primary_id); ?>"><i class="glyphicon glyphicon-trash icon-white"></i></a>
                                  @else
