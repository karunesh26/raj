             	 ...
             	 <div class="box-body">
                   ...
                   {!! Form::hidden('id',$result[0]->$primary_id, array('id'=>"id")) !!}
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        {!! Form::label('Employee Type') !!} <span class="required">*</span>
                        </div>
                        <div class="form-group col-sm-6">
                        {!! Form::text('name',$result[0]->$field, array('class' => 'form-control ' ,'id'=>"name",'placeholder'=>'Enter Employee Type','required' => 'required')) !!}
