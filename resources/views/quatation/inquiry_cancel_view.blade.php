				...
				{!! Form::hidden('q_master_id',$q_master_id, array('id'=>"q_master_id")) !!}
					...
					<div class="form-group col-sm-12">
						<div class="form-group col-sm-12"> 
								...
								{!! Form::textarea('cancel_reason',$result[0]->cancel_reason, array('class' => 'form-control ' ,'id'=>"cancel_reason",'placeholder'=>'Enter Cancel Remarks','size'=>'20*3','readonly'=>readonly)) !!}
						</div>
					</div>
				</div>
...
jQuery(document).ready(function($){
	...
	var c1 = text.includes("VISITOR");
	var c2 = text.includes("Visitor");
	var c3 = text.includes("visitor");
