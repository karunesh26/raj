      ...
      <div class="row">
       <div class="box ">
		...
		<table class="no_border" width="100%" style="margin-left: 2%; ">
			<tr>
				<td colspan="3" style="padding-right: 2%; "  align="right" class="no_border">Date :- {{ date('jS F Y',strtotime($result[0]->revise_date)) }}
			</tr>
			<tr>
				<td colspan="3" style="padding-right: 2%; "   align="right" class="no_border">{{ date('l',strtotime($result[0]->revise_date))}}
			</tr>
			<tr>
