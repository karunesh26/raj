            ...
            <div class="box-body">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <select name="source_id" id="source_id" class="select2" <?php if ($action == 'update') {
    echo "disabled";
} ?> style="width:100%">
...
<?php $spe_id_arr[] .= $v->specification_id; ?>
                    @endforeach
    ...
    jQuery(document).ready(function ($) {
        ...
        $('#frm').on('submit', function (e) {
            ...
            if ($("#frm").valid())
            {
                ...
                var new_quatation_product_id = $("select.quatation_product_id").map(function () {
                    return $(this).val();
                }).get().join(",");
                var new_qty = $("input[id=qty]").map(function () {
                    return $(this).val();
                }).get().join(",");
                var new_rate = $("input[id=rate]").map(function () {
                    return $(this).val();
                }).get().join(",");
                var new_specification_id = $("input:checkbox[id=specification_id]:checked").map(function () {
                    return $(this).val();
                }).get().join(",");
