                      ...
                      <table id="datatable" class="table table-bordered table-striped">
                       ...
                       <tbody>
                            ...
                            @foreach ($result as $key=>$value)
                                <?php
                                    if($value->cur_type == 'inr')
                                        $cur_type = "INR";
                                    else if($value->cur_type == 'dollar')
                                        $cur_type = "Dollar";
                                    else
                                        $cur_type = "-";
                                ?>
                            <tr>
                                ...
                                <td>
									...
									<?php
									/*
									<a class="btn bg-maroon btn-flat btn-sm" onclick="return confirm('Are You Sure To Delete This State.Because This State Related All City Also Deleted?')" href="<?php echo $controller_name;?>/delete/<?php echo $utility->encode($value->$primary_id); ?>"><i class="glyphicon glyphicon-trash icon-white"></i></a>
									*/
									?>
								</td>
                            </tr>
