  	...
  	<div class="login-logo"><b><?php echo $company_data[0]->name;?></b>
  		...
  		<div class="login-box-body">
   			 ...
   			 <p class="login-box-msg">Sign In</p>
                 ...
                 <?php	echo Form::open(array('action' => 'Login@doLogin', 'method' => 'post' , 'files' => true ,'id'=>"frmLogin",'name'=>"frmLogin"))
						...
						{{ csrf_field() }}
                    	 ...
                    	 <div class="form-group has-feedback">
                          ...
                          <?php
                            ...
                            echo Form::password('password', array('class'=> 'form-control' ,'id'=>"password",'placeholder'=>'Password','required' => 'required'));
                         ...
                         <div class="row">
       							...
       							<div class="col-xs-8">
									<h4> <a href="{{ URL::to('forgot_password') }}">Forgot Password</a></h4>
                             	</div>
