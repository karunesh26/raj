                                ...
                                <td>
                                  @if($role_id == 1)
                                    <a title="Edit" class="btn bg-purple btn-flat btn-sm" href="<?php echo $controller_name;?>/edit/<?php echo $utility->encode($value->$primary_id); ?>"><i class="glyphicon glyphicon-edit icon-white"></i></a>
                                     ...
                                     <a class="btn bg-maroon btn-flat btn-sm" onclick="return confirm('Are You Sure To Delete This Document Name ?')" href="<?php echo $controller_name;?>/delete/<?php echo $utility->encode($value->$primary_id); ?>"><i class="glyphicon glyphicon-trash icon-white"></i></a>
                                  @else 
