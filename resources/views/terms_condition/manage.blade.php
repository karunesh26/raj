                      ...
                      <tbody>
                            ...
                            <tr>
                                ...
                                <td>
									...
									<?php /*?>
									<a class="btn bg-maroon btn-flat btn-sm" onclick="return confirm('Are You Sure To Delete?')" href="<?php echo $controller_name;?>/delete/<?php echo $utility->encode($value->$primary_id); ?>"><i class="glyphicon glyphicon-trash icon-white"></i></a><?php */?>
                                </td>
                            </tr>
                          @endforeach
					  </tbody>
