                      ...
                      <table id="datatable" class="table table-bordered table-striped">
                       ...
                       <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $value->name}}</td>
                                <td>
                                   <a target="_blank" title="View" class="btn bg-green btn-flat btn-sm" href="<?php echo $controller_name;?>/view/<?php echo $utility->encode($value->$primary_id); ?>"><i class="glyphicon glyphicon-eye-open icon-white"></i></a>
